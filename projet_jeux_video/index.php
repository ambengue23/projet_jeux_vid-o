...
<head>
  ...
  <style>
    body {
      ...
      background-image: url('image/technicien.jpg');
...
<body>
  ...
  <div class= class>
    <a href="projet_jeux_video/image/technicien.jpg"></a>
  </div>
  ...
  <div class=section style="background-image: url('image/technicien.jpg'); background-size: cover; background-repeat: no-repeat; padding: 20px;">
   ...
   <h2>Espace technicien </h2>
     <div class="menu">
       ...
       <a href="technician/liste_techniciens.php">voir tous les techniciens</a>
     </div>
  </div>
